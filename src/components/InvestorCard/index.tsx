  ...
  useEffect(() => {
    if (ticker) {
      dispatch(
        fetchCompanyDashboard(
          createDynamicURL(
            `${baseURL}/company-dashboard/?ticker=${ticker}`,
            undefined,
            undefined
          )
        )
            ...
            <div className="w-full">
              {dashboardDataList?.length > 0 && (
                <div className="flex justify-between items-center xs:flex-col sm:flex-row py-3">
                  <h1 className="text-lg font-bold">
                    Top {dashboardDataList?.length} Investor
                  </h1>
              ...
              <div className="mt-5">
                <div
                  className={clsx([
                    locationPathName === "/" &&
                      "min-h-[300px] max-h-[300px] overflow-y-scroll",
                  ])}
                >
                              ...
                              >
                                {dashboard?.institution_name && (
                                  <>
                                    <Table.Td className="flex items-center">
                                      <div className="w-9 h-9 mr-3 overflow-hidden rounded-full image-fit border-[3px] border-slate-200/70">
                                        <img
                                          ...
                                          src={
                                            dashboard?.institution_logo_url ??
                                            userLinkedinImage
                                          }
                                        />
                                      </div>
                                    ...
                                    <Table.Td className="cell py-2 h-[50px] border-dashed dark:bg-darkmode-600">
                                      {dashboard?.company_engaged === true && (
                                        <div className="whitespace-nowrap flex items-center justify-center">
                                          <div className="bg-[#0DDE7B] font-semibold flex items-center justify-center rounded-full w-5 h-5 text-[10px] text-white ">
                                            ✔
                                          </div>
                                    ...
                                    <Table.Td className="cell py-2 h-[50px] border-dashed dark:bg-darkmode-600">
                                      <div className="whitespace-nowrap flex items-center justify-center">
                                        <div
                                          className={clsx([
                                            dashboard?.engagement_topic?.toLowerCase() ===
                                              "s" && "bg-[#F5A623] ",
                                            dashboard?.engagement_topic?.toLowerCase() ===
                                              "e" && "bg-[#05703E] ",
                                            dashboard?.engagement_topic?.toLowerCase() ===
              ...
              <Table>
                <Table.Thead>
                  <Table.Tr className="row">
                    ...
                    <Table.Td className="cell py-2 font-semibold w-[180px] h-[50px]  bg-header first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] border-header text-[#000000B2]">
                      Eng Priorities
                    </Table.Td>
                    <Table.Td className="cell py-2 font-semibold h-[50px]  bg-header first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] border-header text-[#000000B2]">
                  ...
                  {dashboardDataList?.length > 0 &&
                    dashboardDataList.map((dashboard: CompanyDashboard) => (
                      ...
                      >
                        ...
                        <Table.Td className="cell py-2 h-[50px] border-dashed dark:bg-darkmode-600">
                          <div className="whitespace-nowrap ">11.43%</div>
                        </Table.Td>
                        <Table.Td className="cell py-2 h-[50px] border-dashed dark:bg-darkmode-600">
                          <div className="whitespace-nowrap ">
                            {dashboard.proxy_advisor_influence || "-"}
                        ...
                        <Table.Td className="cell py-2 h-[50px] border-dashed dark:bg-darkmode-600">
                          <div className="whitespace-nowrap ">ISS, GL</div>
                        </Table.Td>
