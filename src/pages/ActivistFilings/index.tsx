...
function ActivistFilings() {
  ...
  const { companyGlobalSearchId, companyGlobalSearchName } = useAppSelector((state) => state.authentiction);
        ...
        <div className="mt-3.5 relative">
          {!hasCompany ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
              ...
              <div className="flex items-center justify-end gap-3 text-sm text-slate-600 mb-4">
