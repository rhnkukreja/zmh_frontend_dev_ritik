...
const index = () => {
  ...
  const [dropdownInstitutionValues, setDropdownInstitutionValues] =
    useState<any>({
      instututes: [],
    });
                              ...
                              {groupedQuestions ? (
                                Object.entries(groupedQuestions).map(
                                  (
                                    ...
                                    const companyTicker =
                                      institutionQuestions[0]?.company_ticker;
                                    return (
                                      <>
                                        <Table.Tr
