                                ...
                                (vdsHeader: any, headerIndex: number) => (
                                  <Table.Td
                                    ...
                                    className={clsx([
                                      ...
                                      headerIndex === 0 &&
                                        "sticky left-0 bg-header z-20", // Fix first column
                                      headerIndex === 1 &&
                                        "sticky left-[50px] bg-header z-20", // Fix second column (adjust 'left' value according to width)
                                    ])}
                                  >
                                    {vdsHeader?.header}
                                  </Table.Td>
                                      ...
                                      (vdsHeader: any, headerIndex: number) => (
                                        <Table.Td
                                          ...
                                          className={clsx([
                                            ...
                                            headerIndex === 0 &&
                                              "sticky left-0 bg-white  z-10", // Fix first column
                                            headerIndex === 1 &&
                                              "sticky left-[50px] bg-white z-10", // Fix second column
                                          ])}
                                        >
                                          <h1
                                            className={clsx([
