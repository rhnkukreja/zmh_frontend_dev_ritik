...
const DetailDialog: React.FC<ShareholderActionDetailProps> = ({
    ...
    useEffect(() => {
        console.log(selectedShareholderDetail);
    }, [])


    return (
        <>
            <Dialog size="xl" open={shareholderDetailModalVisible}
                onClose={() => {
