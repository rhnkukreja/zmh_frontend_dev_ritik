            ...
            <div className="flex-1 space-y-2">
              <div className="flex-1 space-y-2">
                <p className="text-sm font-medium text-blue-800 dark:text-blue-200">
                  Introduced <strong>Analytics and Charts</strong> highlighting
                  Proxy Advisory Influence and Meeting Details.
                </p>
                <p className="text-sm font-medium text-blue-800 dark:text-blue-200">
                  Added <strong>Q3 2025 Voting Data</strong> for BlackRock,
