  ...
  return (
    <div
      className={clsx([
        ...
        "before:content-[''] before:h-[370px] before:w-screen bg-white h-7 [&.background--hidden]:before:opacity-0 before:transition-[opacity,height] before:ease-in-out before:duration-300 before:top-0 before:fixed",
